...
const Article = ({ articles }) => {
  ...
  const [{ title, body, author, category, updatedAt, image, description }] = art
  return (
      ...
      <div className='flex justify-between px-4 mx-auto'>
        <article className='mx-auto w-full max-w-4xl'>
          ...
          <div className='mt-4 prose max-w-none leading-normal prose-h2:mt-[1em] prose-h2:mb-[0.5em] md:items-start w-full'>
            <ReactMarkdown remarkPlugins={[remarkBreaks]} className='hyperlink'>
              {body}
            </ReactMarkdown>
          </div>
          <div className='mx-auto w-full max-w-4xl mt-8'>
            <div className='items-center bg-gray-50 rounded-lg bg-gray-three sm:flex px-8 pt-8 lg:pt-0'>
              ...
              <div className='p-5 pb-8'>
                ...
                <span className='text-gray-500'>Tech SEO</span>
