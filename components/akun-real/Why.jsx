      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:text-center'>
          <h2 className='mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl'>
            Unlock the Power of Real Forex Trading Accounts - Why Trade with Us?
          </h2>
          <p className='mt-6 text-lg leading-8 text-slate-six'>
            Join the elite group of successful traders who have already achieved
            their financial goals with our Real Forex Trading Accounts. Sign up
            now and unleash the full potential of the world's largest financial
            market!
          </p>
        </div>
