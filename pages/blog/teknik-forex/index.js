...
const TeknikIndex = ({ articles, categories }) => {
      ...
      <div className='overflow-x-hidden '>
        <div className='bg-black bg-[url(/images/banner-bg.png)]'>
          <nav className='bg-black'>
            <Breadcrumb3 title1='Blog' slug='blog' title2='Teknik' />
          </nav>
          <HeroPage
            title='Teknik'
            desc='Metode analisis forex mencakup analisis teknikal, analisis fundamental,  analisis sentimen, dan teknik trading khusus seperti trading harmonic, trading dengan pola grafik tertentu, serta trading dengan indikator tertentu.'
          />
        </div>
